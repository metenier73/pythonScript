    ...
    try:
        ...
        while True:
            if rep0 == "1":
                ...
                rep0 = input("Outils ordinateur 1, Disque 2, Réseau 3, Sécurité 4 ou Quitter 5 ? 1|2|3|4|5 :")
            elif rep0 < "1":
...
def print_Ordi():
    try:
        ordi0 = input(str("Administration ordinateur 1, Configuration ordinateur 2, ou Quitter 3 : 1|2|3 :"))
        ordi = int(ordi0)
        if ordi0 == "1":
            ordi = input(str("Ajouter compte 1, Propriété System 2,Analyse virus 3 ,Access Distance 4 ,Gestionnaire "
                         "périphérique 5 ou Quitter 6 ? 1|2|3|4|5|6:"))
            if ordi == "1":
                os.system("netplwiz")
            elif ordi == "2":
                os.system("sysdm.cpl")
...
def print_Di():
    try:
        ...
        if disc0 == "1":
            disc = input(str(
                "Observateur d'événements 1, Registre 2, Service 3, Moniteur ressource 4, Gestionnaire disque 5 où "
                "Quitter 6 ? "
                "1|2|3|4|5 :"))
            if disc == "1":
...
def print_R():
    try:
        lan0 = input(str("Configuration IP 1, Propriétés internet 2, Terminal 3, Connexion réseau 4 où Quitter 5 ? 1|2|3|4|5 :"))
        lan = int(lan0)
        if lan0 == "1":
            os.system('IPCONFIG')
        elif lan0 == "2":
            ...
            print("nombre trop grand")
            lan0 = input(int("Configuration IP 1, Propriétés internet 2, Terminal 3, Connexion réseau 4 ? 1|2|3|4 :"))
...
def print_S():
    try:
        secu0 = input(str("Pare-feu 1, Fonction avancées Pare-feu 2, Sécurité 3 où Quitter 4 ? 1|2|3|4 :"))
        secu = int(secu0)
        if secu0 == "1":
